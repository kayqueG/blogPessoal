...
public class PostagemController {
	...
	@Autowired
	private PostagemRepository postagemRepository; // declarando o objeto
	...
	public ResponseEntity<List<Postagem>> getByTitulo(@PathVariable String titulo) {
		return ResponseEntity.ok(postagemRepository.findAllByTituloContainingIgnoreCase(titulo)); // OK = 200
